...
bool ProcBIOSInfo (void* p)
{
    ...
    obj.Vendor = toString (LocateString (str, pBIOS->Vendor));
    obj.Version = toString (LocateString (str, pBIOS->Version));
